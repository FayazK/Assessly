                  ...
                  {questions.data.length === 0 ? (
                    <tr>
                      <td colSpan="6" className="px-6 py-4 text-center">
                        No questions found. <Link href={route('admin.questions.create')} className="text-blue-600 hover:underline">Create your first question</Link>.
                      </td>
                    </tr>
                  ) : (
                    questions.data.map((question) => (
                      <tr key={question.id} className="border-b dark:border-gray-700">
                        <td className="px-6 py-4 font-medium">
                          <Link href={route('admin.questions.show', question.id)} className="text-blue-600 hover:underline">
                            {question.title}
                          </Link>
                        </td>
                        ...
                        <td className="px-6 py-4">
                          <div className="flex flex-wrap gap-1">
                            ...
                            {question.tags_with_type.filter(tag => tag.type === 'tag').length > 3 && (
                              <Badge variant="outline">+{question.tags_with_type.filter(tag => tag.type === 'tag').length - 3}</Badge>
                            )}
                          </div>
                        </td>
                        <td className="px-6 py-4">
